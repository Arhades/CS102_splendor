...
public class SplendorClient {
    ...
    public static void main(String[] args) {
        try {
            ...
            String playerBirthday = null;
            DateTimeFormatter formatter = DateTimeFormatter.ofPattern("dd/mm/yyyy");
            while (true) {
                System.out.println("ENTER YOUR INFO");
                System.out.println("Enter your player name: ");
                playerName = scanner.nextLine();
                System.out.println("Enter your birthday in the format dd/mm/yyyy: ");
                ...
                while (!validDateEntered) {
                    ...
                    try {
                        ...
                        System.out.println("Invalid input. Please enter your birth date in the format dd/mm/yyyy: ");  
                    }

                }
            }

            // i should let them enter the date so they can let the youngest start first



            // this displays the options for the clients for them to send the number back to the server
            while (true) {
                System.out.println("\n=============== YOUR TURN ===============");
                ...
                switch (input) {
                    case "1":
                        ...
                        out.println("TAKE_THREE:" + color1 + ":" + color2 + ":" + color3);
                        break;
                        
                    case "2":
                        System.out.print("Enter the color you want 2 of: ");
                        String color = scanner.nextLine().toUpperCase();
                        out.println("TAKE_TWO:" + color);
                        break;
